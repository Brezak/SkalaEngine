...
impl<T> ShlAssign<T> for FractionNum
where
    u64: ShlAssign<T>,
{
...
impl<T> ShrAssign<T> for FractionNum
where
    u64: ShrAssign<T>,
{
...
impl<T> Shl<T> for SignedFractionNum
where
...
impl<T> ShlAssign<T> for SignedFractionNum
where
    i64: ShlAssign<T>,
{
    fn shl_assign(&mut self, rhs: T) {
...
impl<T> Shr<T> for SignedFractionNum
where
...
impl<T> ShrAssign<T> for SignedFractionNum
where
    i64: ShrAssign<T>,
{
    fn shr_assign(&mut self, rhs: T) {
...
impl Neg for SignedFractionNum {
    type Output = Self;
...
mod test {
    ...
    fn test_addtion() {
        assert_eq!(
            FractionNum::new(1) + FractionNum::new(2),
            FractionNum::new(3)
        );
        assert_eq!(
            SignedFractionNum::new(1) + SignedFractionNum::new(2),
            SignedFractionNum::new(3)
        );

        assert_eq!(
            SignedFractionNum::new(1) + SignedFractionNum::new(-2),
            SignedFractionNum::new(-1)
        );
    ...
    fn test_multiplication() {
        ...
        assert_eq!(
            FractionNum::new(2) * FractionNum::new(2),
            FractionNum::new(4)
        );
        ...
        assert_eq!(
            SignedFractionNum::new(2) * SignedFractionNum::new(2),
            SignedFractionNum::new(4)
        );
    ...
    fn test_division() {
        ...
        assert_eq!(
            FractionNum::new(4) / FractionNum::new(2),
            FractionNum::new(2)
        );
        assert_eq!(
            SignedFractionNum::new(4) / SignedFractionNum::new(2),
            SignedFractionNum::new(2)
        );
        assert_eq!(
            SignedFractionNum::new(-4) / SignedFractionNum::new(2),
            SignedFractionNum::new(-2)
    ...
    #[test]
    fn test_neg() {
        assert_eq!(-SignedFractionNum::new(2), SignedFractionNum::new(-2));
        assert_eq!(-SignedFractionNum::new(-2), SignedFractionNum::new(2))
    }
